...
function DetailsPanel({ order, onClose, onUpdateOrder }) {
    ...
    try {
      ...
      for (const dept of departments) {
        ...
        try {
          ...
          const response = await fetch(`https://api.metaspark.co.in/users/assigned-to-order/${orderId}/${dept}`, {
          ...
          if (response.ok) {
            ...
            if (dept === 'MACHINING' && assignedUser && assignedUser.machineId) {
              ...
              try {
                ...
                const machineResponse = await fetch(`https://api.metaspark.co.in/machine/getMachine/${assignedUser.machineId}`, {
  ...
  const handleAssignUser = async (department, userId) => {
    ...
    try {
      ...
      const response = await fetch('https://api.metaspark.co.in/users/assign-to-order', {
  ...
  const saveStageProgress = async (stageKey, progressValue) => {
    ...
    try {
      ...
      const response = await fetch(`https://api.metaspark.co.in/order/${orderId}/stage-progress`, {
                    ...
                    {keysInRoleOrder.map((key) => (
                      ...
                      <div key={key}>
                        ...
                        <input
                          ...
                          disabled={isSavingStageProgress}
...
export default function DashboardPage() {
  ...
  const handleSaveInlineCustomer = async () => {
    ...
    try {
      ...
      // Auto-select the new customer in the order form
  ...
  const handleSaveInlineProduct = async () => {
    ...
    try {
      ...
      // Auto-select the new product in the order form
                ...
                <div className="p-4 space-y-4 overflow-y-auto flex-1">
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <label className="block text-xs font-medium text-black">Customer</label>
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <label className="block text-xs font-medium text-black">Products</label>
                  ...
                  <div>
                    ...
                    <label className="block text-xs font-medium mb-1 text-black">
                      ...
                      Or Enter Custom Product Details
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        ...
                        setForm((f) => ({ ...f, custom: e.target.value }))
