...
{/* 
                ...
                <div className="bg-white border-t border-gray-200 p-6">
                    <div className="flex items-center justify-between mb-3">
                        <h1 className="text-lg font-semibold text-black">Machine Department</h1>
                    </div>
                    <div className="flex items-center justify-between mb-3 text-black">
                        <p>Manage all assigned machining jobs.
                        </p>
                    </div>
...
function SidebarItem({ label, active = false }) {
    return (
        <div
            className={`px-3 py-2 rounded-md cursor-pointer ${active ? 'bg-gray-100 text-black font-medium' : 'text-black hover:bg-gray-50'
                }`}
        >
            {label}
        </div>
