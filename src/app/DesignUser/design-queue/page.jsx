...
export default function DesignQueuePage() {
  ...
  // Upload state for showing a global loading indicator during PDF upload
  ...
  const handleUploadClick = (orderId) => {
    ...
    setUploadingOrderId(orderId || null);
  ...
  const handleFileChange = async (event) => {
    ...
    console.log("[DesignQueue] Starting PDF upload", {
    ...
    try {
      ...
      if (!uploadResponse.ok) {
        ...
        console.error("[DesignQueue] PDF upload failed with status", uploadResponse.status);
      ...
      if (!uploadedUrl) {
        ...
        console.error("[DesignQueue] Upload response missing attachmentUrl/url", uploadData);

        setToast({ message: "Upload succeeded but no PDF URL was returned", type: "error" });
      ...
      console.error("[DesignQueue] Error during PDF upload", e);

      setToast({ message: "An error occurred while uploading PDF", type: "error" });
    ...
    <>
      ...
      {isUploading && (
        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40">
          ...
          <div className="bg-white rounded-md px-4 py-3 shadow-md flex items-center gap-3 border border-gray-200">
            ...
            <div className="text-sm text-gray-700">
              ...
              {uploadingOrderId ? (
                ...
                <span>Uploading PDF for order {uploadingOrderId}...</span>
